...
print('2 medium')
print('3 hard')
x=int(input("enter option('1','2','3')")
if x==1:
      print('HALKA HAI KYA')
      print()
      print('CHI!!!!!!!')
      while True:
         ...
         if a!=b and a!=c and a!=d and b!=c and b!=d and b!=a and c!=a and c!=b and c!=d and d!=a and d!=b and d!=c:
          break 
      ...
      n=8
      for i in range(n):
       e=input('enter a 4 digit code')
       try:
        if e[0]==a:
            print('**')
        elif e[0]==b or e[0]==c or e[0]==d :
            print('*')
        if e[1]==b:
            print('**')
        elif e[1]==a or e[1]==c or e[1]==d :
            print('*')
        if e[2]==c:
            print('**')
        elif e[2]==a or e[2]==b or e[2]==d :
            print('*')
        if e[3]==d:
            print('**')
        elif e[3]==a or e[3]==b or e[3]==c :
            print('*')
        if e==code:
      ...
      while True:
       ...
       if a!=b and a!=c and a!=d and a!=e and a!=f and b!=c and b!=d and b!=a and b!=e and b!=f and c!=a and c!=b and c!=d and c!=e and c!=f and d!=a and d!=b and d!=c and d!=e and d!=f and e!=a and e!=b and e!=c and e!=d and e!=f and f!=a and f!=b and f!=c and f!=d and f!=e:
        break 
      print('lets start the game')
      a=str(a)
      b=str(b)
      ...
      n=8
      for i in range(n):
        g=input('enter a 6 digit code')
        try:
         if g[0]==a:
            print('**')
         elif g[0]==b or g[0]==c or g[0]==d or g[0]==e or g[0]==f :
            print('*')
         if g[1]==b:
            print('**')
         elif g[1]==a or g[1]==c or g[1]==d or g[1]==e or g[1]==f :
            print('*')
         if g[2]==c:
            print('**')
         elif g[2]==a or g[2]==b or g[2]==d or g[2]==e or g[2]==f:
            print('*')
         if g[3]==d:
            print('**')
         elif g[3]==a or g[3]==b or g[3]==c or g[3]==e or g[3]==f:
            print('*')
         if g[4]==e:
            print('**')
         elif g[4]==a or g[4]==b or g[4]==c or g[4]==d or g[4]==f:
            print('*')
         if g[5]==f:
            print('**')
         elif g[5]==a or g[5]==b or g[5]==c or g[5]==e or g[5]==d :
            print('*')      
         if g==code:
          print('congratulation')
          print('You Win !!!!!')
